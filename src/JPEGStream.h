...
empty_closure_output_buffer(j_compress_ptr cinfo){
  ...
  Nan::MakeCallback(Nan::GetCurrentContext()->Global(), dest->closure->fn, 3, argv);
...
term_closure_destination(j_compress_ptr cinfo){
  ...
  Nan::MakeCallback(Nan::GetCurrentContext()->Global(), dest->closure->fn, 3, data_argv);
  ...
  Nan::MakeCallback(Nan::GetCurrentContext()->Global(), dest->closure->fn, 3, end_argv);
}
