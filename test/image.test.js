...
describe("Image", function () {
    ...
    it("does not crash on invalid images", function () {
        ...
        return Promise.all(
            corruptSources.map((src) => loadImage(src).catch(() => null))
        );
    });
    ...
    describe("supports BMP", function () {
        ...
        it("parses 24-bit image", function (done) {
            ...
            img.onload = () => {
                ...
                testImgd(
                    img,
                    [
                        0, 0, 255, 255, 0, 255, 0, 255, 255, 0, 0, 255, 255,
                        255, 255, 255,
                    ]
                );
        ...
        it("parses 32-bit image", function (done) {
            ...
            img.onload = () => {
                ...
                testImgd(
                    ...
                    [
                        0, 0, 255, 255, 0, 255, 0, 255, 255, 0, 0, 255, 255,
                        255, 255, 255, 0, 0, 255, 127, 0, 255, 0, 127, 255, 0,
                        0, 127, 255, 255, 255, 127,
                    ]
                );
        ...
        it("properly handles negative height", function (done) {
            ...
            img.onload = () => {
                ...
                testImgd(img, [255, 0, 0, 255, 0, 255, 0, 255]);
        ...
        it("catches BMP errors", function (done) {
            ...
            img.onerror = (err) => {
                const msg =
                    "Error while processing file header - unexpected end of file";
