...
describe("WPT: the-canvas-element", function () {
    ...
    it("2d.getcontext.invalid.args", function () {
        ...
        assert.strictEqual(
            canvas.getContext("This is clearly not a valid context name."),
            null,
            "canvas.getContext('This is clearly not a valid context name.')",
            "null"
        );
        ...
        assert.strictEqual(
            canvas.getContext("2\uFF44"),
            null,
            "canvas.getContext('2\\uFF44')",
            "null"
        );
        assert.strictEqual(
            canvas.getContext("2D"),
    ...
    it("2d.getcontext.extraargs.create", function () {
        ...
        assert.notStrictEqual(
            document
                ...
                .getContext("2d", false, {}, [], 1, "2"),
            null,
            'document.createElement("canvas").getContext(\'2d\', false, {}, [], 1, "2")',
            "null"
        );
        assert.notStrictEqual(
            document.createElement("canvas").getContext("2d", 123),
            null,
            "document.createElement(\"canvas\").getContext('2d', 123)",
            "null"
        );
        assert.notStrictEqual(
            document.createElement("canvas").getContext("2d", "test"),
            null,
            'document.createElement("canvas").getContext(\'2d\', "test")',
            "null"
        );
        ...
        assert.notStrictEqual(
            document
                .createElement("canvas")
                .getContext("2d", Symbol.hasInstance),
            null,
            "document.createElement(\"canvas\").getContext('2d', Symbol.hasInstance)",
            "null"
        );
    });
    ...
    it("2d.getcontext.extraargs.cache", function () {
        ...
        assert.notStrictEqual(
            canvas.getContext("2d", false, {}, [], 1, "2"),
            null,
            "canvas.getContext('2d', false, {}, [], 1, \"2\")",
            "null"
        );
        assert.notStrictEqual(
            canvas.getContext("2d", 123),
            null,
            "canvas.getContext('2d', 123)",
            "null"
        );
        assert.notStrictEqual(
            canvas.getContext("2d", "test"),
            null,
            "canvas.getContext('2d', \"test\")",
            "null"
        );
        ...
        assert.notStrictEqual(
            canvas.getContext("2d", Symbol.hasInstance),
            null,
            "canvas.getContext('2d', Symbol.hasInstance)",
            "null"
        );
    ...
    it("2d.type.prototype", function () {
        ...
        assert(
            window.CanvasRenderingContext2D.prototype.fill,
            "window.CanvasRenderingContext2D.prototype.fill"
        );
    ...
    it("2d.type.extend", function () {
        ...
        window.CanvasRenderingContext2D.prototype.fillRectGreen = function (
            x,
            y,
            w,
            h
    ...
    it("2d.canvas.context", function () {
        ...
        assert.strictEqual(
            Object.getPrototypeOf(CanvasRenderingContext2D.prototype),
            Object.prototype,
            "Object.getPrototypeOf(CanvasRenderingContext2D.prototype)",
            "Object.prototype"
        );
