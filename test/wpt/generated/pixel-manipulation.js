...
describe("WPT: pixel-manipulation", function () {
    ...
    it("2d.imageData.create1.basic", function () {
        ...
        assert.notStrictEqual(
            ctx.createImageData(ctx.createImageData(1, 1)),
            null,
            "ctx.createImageData(ctx.createImageData(1, 1))",
            "null"
        );
    ...
    it("2d.imageData.create2.type", function () {
        ...
        assert(
            imgdata.thisImplementsImageData,
            "imgdata.thisImplementsImageData"
        );
        assert(
    ...
    it("2d.imageData.create2.this", function () {
        ...
        assert.throws(function () {
            CanvasRenderingContext2D.prototype.createImageData.call(
                undefined,
                1,
                1
            );
    ...
    it("2d.imageData.create2.initial", function () {
        ...
        for (var i = 0; i < imgdata.data.length; ++i)
            if (imgdata.data[i] !== 0) isTransparentBlack = false;
    ...
    it("2d.imageData.create1.initial", function () {
        ...
        assert.strictEqual(
            imgdata2.data.length,
            imgdata1.data.length,
            "imgdata2.data.length",
            "imgdata1.data.length"
        );
        assert.strictEqual(
        ...
        for (var i = 0; i < imgdata2.data.length; ++i)
            if (imgdata2.data[i] !== 0) isTransparentBlack = false;
        assert(isTransparentBlack, "isTransparentBlack");
    });
    ...
    it("2d.imageData.create2.large", function () {
        ...
        for (
            ...
            i += 7813 // check ~1024 points (assuming normal scaling)
        )
            if (imgdata.data[i] !== 0) isTransparentBlack = false;
        assert(isTransparentBlack, "isTransparentBlack");
    });
    ...
    it.skip("2d.imageData.create2.negative", function () {
        ...
        assert.strictEqual(
            imgdata2.data.length,
            imgdata3.data.length,
            "imgdata2.data.length",
            "imgdata3.data.length"
        );
        assert.strictEqual(
            imgdata3.data.length,
            imgdata4.data.length,
            "imgdata3.data.length",
            "imgdata4.data.length"
        );
    });
    ...
    it.skip("2d.imageData.create2.zero", function () {
        ...
        assert.throws(function () {
            ctx.createImageData(0.99, 10);
        }, /INDEX_SIZE_ERR/);
        assert.throws(function () {
            ctx.createImageData(10, 0.1);
        }, /INDEX_SIZE_ERR/);
    });
    ...
    it("2d.imageData.get.zero", function () {
        ...
        assert.throws(function () {
            ctx.getImageData(1, 1, 0.1, 10);
        }, /INDEX_SIZE_ERR/);
        assert.throws(function () {
            ctx.getImageData(1, 1, 10, 0.99);
        }, /INDEX_SIZE_ERR/);
        assert.throws(function () {
            ctx.getImageData(1, 1, -0.1, 10);
        }, /INDEX_SIZE_ERR/);
    ...
    it.skip("2d.imageData.get.source.outside", function () {
        ...
        assert.strictEqual(
            imgdata7.data[10 * 4 + 0],
            0,
            "imgdata7.data[10*4+0]",
            "0"
        );
        assert.strictEqual(
            imgdata7.data[10 * 4 + 1],
            136,
            "imgdata7.data[10*4+1]",
            "136"
        );
        assert.strictEqual(
            imgdata7.data[10 * 4 + 2],
            255,
            "imgdata7.data[10*4+2]",
            "255"
        );
        assert.strictEqual(
            imgdata7.data[10 * 4 + 3],
            255,
            "imgdata7.data[10*4+3]",
            "255"
        );
        assert.strictEqual(
            imgdata7.data[19 * 4 + 0],
            0,
            "imgdata7.data[19*4+0]",
            "0"
        );
        assert.strictEqual(
            imgdata7.data[19 * 4 + 1],
            136,
            "imgdata7.data[19*4+1]",
            "136"
        );
        assert.strictEqual(
            imgdata7.data[19 * 4 + 2],
            255,
            "imgdata7.data[19*4+2]",
            "255"
        );
        assert.strictEqual(
            imgdata7.data[19 * 4 + 3],
            255,
            "imgdata7.data[19*4+3]",
            "255"
        );
        assert.strictEqual(
            imgdata7.data[20 * 4 + 0],
            0,
            "imgdata7.data[20*4+0]",
            "0"
        );
        assert.strictEqual(
            imgdata7.data[20 * 4 + 1],
            0,
            "imgdata7.data[20*4+1]",
            "0"
        );
        assert.strictEqual(
            imgdata7.data[20 * 4 + 2],
            0,
            "imgdata7.data[20*4+2]",
            "0"
        );
        assert.strictEqual(
            imgdata7.data[20 * 4 + 3],
            0,
            "imgdata7.data[20*4+3]",
            "0"
        );
    ...
    it.skip("2d.imageData.get.source.negative", function () {
        ...
        assert.strictEqual(
            imgdata1.data[imgdata1.data.length - 4 + 0],
            0,
            "imgdata1.data[imgdata1.data.length-4+0]",
            "0"
        );
        assert.strictEqual(
            imgdata1.data[imgdata1.data.length - 4 + 1],
            0,
            "imgdata1.data[imgdata1.data.length-4+1]",
            "0"
        );
        assert.strictEqual(
            imgdata1.data[imgdata1.data.length - 4 + 2],
            0,
            "imgdata1.data[imgdata1.data.length-4+2]",
            "0"
        );
        assert.strictEqual(
            imgdata1.data[imgdata1.data.length - 4 + 3],
            255,
            "imgdata1.data[imgdata1.data.length-4+3]",
            "255"
        );
    ...
    it("2d.imageData.get.source.size", function () {
        ...
        assert(
            imgdata2.width > imgdata1.width,
            "imgdata2.width > imgdata1.width"
        );
        assert(
            imgdata2.height > imgdata1.height,
            "imgdata2.height > imgdata1.height"
        );
    });
    ...
    it("2d.imageData.get.order.cols", function () {
        ...
        assert.strictEqual(
            imgdata.data[Math.round((imgdata.width / 2) * 4)],
            255,
            "imgdata.data[Math.round(imgdata.width/2*4)]",
            "255"
        );
        assert.strictEqual(
            imgdata.data[Math.round((imgdata.height / 2) * imgdata.width * 4)],
            0,
            "imgdata.data[Math.round((imgdata.height/2)*imgdata.width*4)]",
            "0"
        );
    ...
    it("2d.imageData.get.order.rows", function () {
        ...
        assert.strictEqual(
            imgdata.data[Math.floor((imgdata.width / 2) * 4)],
            0,
            "imgdata.data[Math.floor(imgdata.width/2*4)]",
            "0"
        );
        assert.strictEqual(
            imgdata.data[(imgdata.height / 2) * imgdata.width * 4],
            255,
            "imgdata.data[(imgdata.height/2)*imgdata.width*4]",
            "255"
        );
    ...
    it.skip("2d.imageData.get.large.crash", function () {
        ...
        assert.throws(function () {
            ctx.getImageData(10, 0xffffffff, 2147483647, 10);
        }, TypeError);
    });
    ...
    it("2d.imageData.get.rounding", function () {
        ...
        testDimensions(0.1, 0.2, 20, 10, 20, 10);
        testDimensions(0.9, 0.8, 20, 10, 20, 10);
    ...
    it("2d.imageData.get.invalid", function () {
        ...
        var testResults = [
            0, 1, 0, 0, 0, 0, 1, 2, 255, 0, 0, 0, 0, 0, 5, 5, 255, 255, 0, 0,
        ];
        for (var i = 0; i < testValues.length; i++) {
            imageData.data[0] = testValues[i];
            assert(
                imageData.data[0] == testResults[i],
                'imageData.data["' + 0 + '"] == testResults["' + i + '"]'
            );
        }
    ...
    it("2d.imageData.object.properties", function () {
        ...
        var imgdata = ctx.getImageData(0, 0, 10, 10);
        assert.strictEqual(
            typeof imgdata.width,
            "number",
            "typeof(imgdata.width)",
            "'number'"
        );
        assert.strictEqual(
            typeof imgdata.height,
            "number",
            "typeof(imgdata.height)",
            "'number'"
        );
    ...
    it("2d.imageData.object.ctor.basics", function () {
        ...
        assert.strictEqual(
            imageDataFromData.width,
            100,
            "imageDataFromData.width",
            "100"
        );
        assert.strictEqual(
            imageDataFromData.height,
            50,
            "imageDataFromData.height",
            "50"
        );
        assert.strictEqual(
            imageDataFromData.data,
            imageData.data,
            "imageDataFromData.data",
            "imageData.data"
        );
        assertArrayEquals(
            getRGBA(imageDataFromData.data, 10),
            getRGBA(imageData.data, 10)
        );
    ...
    it("2d.imageData.object.ctor.array.bounds", function () {
        ...
        assert.throws(function () {
            new ImageData(new Uint8ClampedArray(0), 1);
        }, /INVALID_STATE_ERR/);
        assert.throws(function () {
            new ImageData(new Uint8ClampedArray(3), 1);
        }, /INVALID_STATE_ERR/);
        assert.throws(function () {
            new ImageData(new Uint8ClampedArray(4), 0);
        }, /INDEX_SIZE_ERR/);
        assert.throws(function () {
            new ImageData(new Uint8ClampedArray(4), 1, 2);
        }, /INDEX_SIZE_ERR/);
        assert.throws(function () {
            new ImageData(new Uint8Array(8), 1, 2);
        }, TypeError);
        assert.throws(function () {
            new ImageData(new Int8Array(8), 1, 2);
        }, TypeError);
    });
    ...
    it("2d.imageData.put.modified", function () {
        ...
        for (
            var i = 0, len = imgdata.width * imgdata.height * 4;
            i < len;
            i += 4
        ) {
            imgdata.data[i] = 0;
        ...
        for (var y = 0; y < 16; ++y) {
            for (var x = 0; x < 16; ++x, ++i) {
                ctx.fillStyle =
                    ...
                    i +
                    "," +
                    (Math.floor(i * 1.5) % 256) +
                    "," +
                    (Math.floor(i * 23.3) % 256) +
                    "," +
                    i / 256 +
                    ")";
