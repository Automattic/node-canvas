...
describe("WPT: path-objects", function () {
    ...
    it("2d.path.roundrect.radius.toomany", function () {
        ...
        assert_throws_js(RangeError, () => {
            ctx.roundRect(0, 0, 100, 50, [0, 0, 0, 0, 0]);
        });
    });
    ...
    it("2d.path.roundrect.radius.negative", function () {
        ...
        assert_throws_js(RangeError, () => {
            ctx.roundRect(0, 0, 0, 0, [-1]);
        });
        assert_throws_js(RangeError, () => {
            ctx.roundRect(0, 0, 0, 0, [1, -1]);
        });
        assert_throws_js(RangeError, () => {
            ctx.roundRect(0, 0, 0, 0, [new DOMPoint(-1, 1), 1]);
        });
        assert_throws_js(RangeError, () => {
            ctx.roundRect(0, 0, 0, 0, [new DOMPoint(1, -1)]);
        });
        assert_throws_js(RangeError, () => {
            ctx.roundRect(0, 0, 0, 0, [{ x: -1, y: 1 }, 1]);
        });
        assert_throws_js(RangeError, () => {
            ctx.roundRect(0, 0, 0, 0, [{ x: 1, y: -1 }]);
        });
    });
    ...
    it("2d.path.isPointInPath.edge", function () {
        ...
        assert.strictEqual(
            ctx.isPointInPath(0, 10),
            true,
            "ctx.isPointInPath(0, 10)",
            "true"
        );
        assert.strictEqual(
            ctx.isPointInPath(10, -0.01),
            false,
            "ctx.isPointInPath(10, -0.01)",
            "false"
        );
        assert.strictEqual(
            ctx.isPointInPath(10, 20.01),
            false,
            "ctx.isPointInPath(10, 20.01)",
            "false"
        );
        assert.strictEqual(
            ctx.isPointInPath(-0.01, 10),
            false,
            "ctx.isPointInPath(-0.01, 10)",
            "false"
        );
        assert.strictEqual(
            ctx.isPointInPath(20.01, 10),
            false,
            "ctx.isPointInPath(20.01, 10)",
            "false"
        );
    ...
    it("2d.path.isPointInPath.outside", function () {
        ...
        assert.strictEqual(
            ctx.isPointInPath(10, -110),
            false,
            "ctx.isPointInPath(10, -110)",
            "false"
        );
        assert.strictEqual(
            ctx.isPointInPath(10, -90),
            true,
            "ctx.isPointInPath(10, -90)",
            "true"
        );
        assert.strictEqual(
            ctx.isPointInPath(10, -70),
            false,
            "ctx.isPointInPath(10, -70)",
            "false"
        );
        assert.strictEqual(
            ctx.isPointInPath(30, -20),
            false,
            "ctx.isPointInPath(30, -20)",
            "false"
        );
        assert.strictEqual(
            ctx.isPointInPath(30, 0),
            true,
            "ctx.isPointInPath(30, 0)",
            "true"
        );
    ...
    it("2d.path.isPointInPath.arc", function () {
        ...
        assert.strictEqual(
            ctx.isPointInPath(50, 20),
            false,
            "ctx.isPointInPath(50, 20)",
            "false"
        );
        assert.strictEqual(
            ctx.isPointInPath(50, 30),
            true,
            "ctx.isPointInPath(50, 30)",
            "true"
        );
        assert.strictEqual(
            ctx.isPointInPath(50, 40),
            false,
            "ctx.isPointInPath(50, 40)",
            "false"
        );
        ...
        assert.strictEqual(
            ctx.isPointInPath(70, 20),
            false,
            "ctx.isPointInPath(70, 20)",
            "false"
        );
        assert.strictEqual(
            ctx.isPointInPath(30, 30),
            false,
            "ctx.isPointInPath(30, 30)",
            "false"
        );
        assert.strictEqual(
            ctx.isPointInPath(70, 30),
            false,
            "ctx.isPointInPath(70, 30)",
            "false"
        );
    ...
    it("2d.path.isPointInPath.bezier", function () {
        ...
        assert.strictEqual(
            ctx.isPointInPath(25, 20),
            false,
            "ctx.isPointInPath(25, 20)",
            "false"
        );
        assert.strictEqual(
            ctx.isPointInPath(25, 30),
            false,
            "ctx.isPointInPath(25, 30)",
            "false"
        );
        ...
        assert.strictEqual(
            ctx.isPointInPath(40, 2),
            false,
            "ctx.isPointInPath(40, 2)",
            "false"
        );
        assert.strictEqual(
            ctx.isPointInPath(40, 20),
            true,
            "ctx.isPointInPath(40, 20)",
            "true"
        );
        assert.strictEqual(
            ctx.isPointInPath(40, 30),
            false,
            "ctx.isPointInPath(40, 30)",
            "false"
        );
        assert.strictEqual(
            ctx.isPointInPath(40, 47),
            false,
            "ctx.isPointInPath(40, 47)",
            "false"
        );
        assert.strictEqual(
            ctx.isPointInPath(45, 20),
            true,
            "ctx.isPointInPath(45, 20)",
            "true"
        );
        assert.strictEqual(
            ctx.isPointInPath(45, 30),
            false,
            "ctx.isPointInPath(45, 30)",
            "false"
        );
        assert.strictEqual(
            ctx.isPointInPath(55, 20),
            false,
            "ctx.isPointInPath(55, 20)",
            "false"
        );
        assert.strictEqual(
            ctx.isPointInPath(55, 30),
            true,
            "ctx.isPointInPath(55, 30)",
            "true"
        );
        assert.strictEqual(
            ctx.isPointInPath(60, 2),
            false,
            "ctx.isPointInPath(60, 2)",
            "false"
        );
        assert.strictEqual(
            ctx.isPointInPath(60, 20),
            false,
            "ctx.isPointInPath(60, 20)",
            "false"
        );
        assert.strictEqual(
            ctx.isPointInPath(60, 30),
            true,
            "ctx.isPointInPath(60, 30)",
            "true"
        );
        assert.strictEqual(
            ctx.isPointInPath(60, 47),
            false,
            "ctx.isPointInPath(60, 47)",
            "false"
        );
        ...
        assert.strictEqual(
            ctx.isPointInPath(75, 20),
            false,
            "ctx.isPointInPath(75, 20)",
            "false"
        );
        assert.strictEqual(
            ctx.isPointInPath(75, 30),
            false,
            "ctx.isPointInPath(75, 30)",
            "false"
        );
    ...
    it("2d.path.isPointInPath.winding", function () {
        ...
        assert.strictEqual(
            ctx.isPointInPath(25, 5),
            true,
            "ctx.isPointInPath(25, 5)",
            "true"
        );
        assert.strictEqual(
            ctx.isPointInPath(45, 5),
            true,
            "ctx.isPointInPath(45, 5)",
            "true"
        );
        assert.strictEqual(
            ctx.isPointInPath(5, 25),
            true,
            "ctx.isPointInPath(5, 25)",
            "true"
        );
        assert.strictEqual(
            ctx.isPointInPath(25, 25),
            false,
            "ctx.isPointInPath(25, 25)",
            "false"
        );
        assert.strictEqual(
            ctx.isPointInPath(45, 25),
            true,
            "ctx.isPointInPath(45, 25)",
            "true"
        );
        assert.strictEqual(
            ctx.isPointInPath(5, 45),
            true,
            "ctx.isPointInPath(5, 45)",
            "true"
        );
        assert.strictEqual(
            ctx.isPointInPath(25, 45),
            true,
            "ctx.isPointInPath(25, 45)",
            "true"
        );
        assert.strictEqual(
            ctx.isPointInPath(45, 45),
            true,
            "ctx.isPointInPath(45, 45)",
            "true"
        );
    ...
    it("2d.path.isPointInPath.transform.1", function () {
        ...
        assert.strictEqual(
            ctx.isPointInPath(49, 10),
            false,
            "ctx.isPointInPath(49, 10)",
            "false"
        );
        assert.strictEqual(
            ctx.isPointInPath(51, 10),
            true,
            "ctx.isPointInPath(51, 10)",
            "true"
        );
        assert.strictEqual(
            ctx.isPointInPath(69, 10),
            true,
            "ctx.isPointInPath(69, 10)",
            "true"
        );
        assert.strictEqual(
            ctx.isPointInPath(71, 10),
            false,
            "ctx.isPointInPath(71, 10)",
            "false"
        );
    ...
    it("2d.path.isPointInPath.transform.4", function () {
        ...
        ctx.translate(0, 50);
        assert.strictEqual(
            ctx.isPointInPath(60, 10),
            false,
            "ctx.isPointInPath(60, 10)",
            "false"
        );
        assert.strictEqual(
            ctx.isPointInPath(110, 10),
            true,
            "ctx.isPointInPath(110, 10)",
            "true"
        );
        assert.strictEqual(
            ctx.isPointInPath(110, 60),
            false,
            "ctx.isPointInPath(110, 60)",
            "false"
        );
    ...
    it("2d.path.isPointInPath.nonfinite", function () {
        ...
        assert.strictEqual(
            ctx.isPointInPath(NaN, 0),
            false,
            "ctx.isPointInPath(NaN, 0)",
            "false"
        );
        assert.strictEqual(
            ctx.isPointInPath(0, Infinity),
            false,
            "ctx.isPointInPath(0, Infinity)",
            "false"
        );
    ...
    it("2d.path.isPointInStroke.scaleddashes", function () {
        ...
        assert.strictEqual(
            ctx.isPointInStroke(11 * scale, 10 * scale),
            true,
            "ctx.isPointInStroke(11*scale, 10*scale)",
            "true"
        );
        ...
        assert.strictEqual(
            ctx.isPointInStroke(8.7 * scale, 14.21 * scale),
            true,
            "ctx.isPointInStroke(8.70*scale, 14.21*scale)",
            "true"
        );
        // hit-test the end of the dash (t=9.8)
        assert.strictEqual(
            ctx.isPointInStroke(4.1 * scale, 14.63 * scale),
            true,
            "ctx.isPointInStroke(4.10*scale, 14.63*scale)",
            "true"
        );
        // hit-test past the end of the dash (t=10.2)
        assert.strictEqual(
            ctx.isPointInStroke(3.74 * scale, 14.46 * scale),
            false,
            "ctx.isPointInStroke(3.74*scale, 14.46*scale)",
            "false"
        );
    ...
    it("2d.path.isPointInPath.basic", function () {
        ...
        assert.strictEqual(
            ctx.isPointInPath(NaN, 50),
            false,
            "ctx.isPointInPath(NaN, 50)",
            "false"
        );
        assert.strictEqual(
            ctx.isPointInPath(50, NaN),
            false,
            "ctx.isPointInPath(50, NaN)",
            "false"
        );
    ...
    it("2d.path.isPointInpath.multi.path", function () {
        ...
        assert.strictEqual(
            ctx.isPointInPath(path, 50, 50, undefined),
            true,
            "ctx.isPointInPath(path, 50, 50, undefined)",
            "true"
        );
