    ...
    it("2d.text.draw.space.collapse.other", function () {
        ...
        step_timeout(
            t.step_func_done(function () {
                ...
                ctx.fillStyle = "#0f0";
                ctx.fillText(
                    "E \x09\x0a\x0c\x0d  \x09\x0a\x0c\x0dEE",
                    -100,
                    37.5
                );
                _assertPixelApprox(canvas, 25, 25, 0, 255, 0, 255);
        ...
        document.fonts.ready.then(() => {
            step_timeout(
                t.step_func_done(function () {
                    ...
                    assert.strictEqual(
                        ctx.measureText("A \x09\x0a\x0c\x0d  \x09\x0a\x0c\x0dB")
                            .width,
                        150,
                        "ctx.measureText('A \\x09\\x0a\\x0c\\x0d  \\x09\\x0a\\x0c\\x0dB').width",
                        "150"
                    );
                    assert(
                        ctx.measureText("A \x0b B").width >= 200,
                        "ctx.measureText('A \\x0b B').width >= 200"
                    );

                    assert.strictEqual(
                        ctx.measureText(" AB").width,
                        100,
                        "ctx.measureText(' AB').width",
                        "100"
                    );
