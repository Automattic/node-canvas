...
describe("WPT: shadows", function () {
    ...
    it("2d.shadow.image.section", function () {
        ...
        ctx.shadowColor = "#f00";
        ctx.drawImage(
            document.getElementById("redtransparent.png"),
            50,
            0,
            50,
            50,
    ...
    it("2d.shadow.pattern.basic", function () {
        ...
        var pattern = ctx.createPattern(
            document.getElementById("red.png"),
            "repeat"
        );
        ctx.fillStyle = "#f00";
        ctx.fillRect(0, 0, 100, 50);
    ...
    it("2d.shadow.pattern.transparent.1", function () {
        ...
        var pattern = ctx.createPattern(
            document.getElementById("transparent.png"),
            "repeat"
        );
        ctx.fillStyle = "#0f0";
        ctx.fillRect(0, 0, 100, 50);
    ...
    it("2d.shadow.pattern.alpha", function () {
        ...
        var pattern = ctx.createPattern(
            document.getElementById("transparent50.png"),
            "repeat"
        );
        ctx.fillStyle = "#f00";
        ctx.fillRect(0, 0, 100, 50);
